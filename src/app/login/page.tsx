...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[var(--dark-color)] flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 bg-white/10 backdrop-blur-lg border border-white/20 px-6 py-4 rounded-2xl shadow-2xl w-full max-w-[340px] text-center">
                ...
                <div className="absolute top-3 right-3 flex items-center gap-1 text-[10px] text-white/50">
                    ...
                    <img src="/logo.png" alt="S" className="w-3 h-3 object-contain opacity-80" />
                ...
                {user ? (
                    ...
                    <>
                        <div className="mb-6 mt-[13px] flex justify-center">
                            {/* Placeholder for Aurea Logo */}
                            <div className="w-24 h-24 bg-gradient-to-br from-amber-400 to-yellow-600 rounded-2xl flex items-center justify-center text-white font-serif font-bold text-5xl shadow-2xl border-2 border-white/20">
                                A
                            </div>
                        </div>
                ...
                {!user && (
                    <div className="space-y-4">
                        ...
                        <button
                            onClick={() => {
                                if (!showBiometric) {
                                    alert("Nota: La biometría no parece estar activada en este dispositivo. Intentando verificar de todos modos...");
                                }
