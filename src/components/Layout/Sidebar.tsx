...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
    ...
    const handleDownloadClick = (e: React.MouseEvent) => {
        ...
        if (userAgent.includes('win')) {
            window.location.href = '/downloads/Synaptica-Setup.exe';
    ...
    return (
      ...
      `}>
                <div className="pt-4 px-4 flex justify-end md:hidden">
                ...
                <nav className="px-4 py-6 space-y-1 overflow-y-auto max-h-[calc(100vh-140px)] no-scrollbar">
                ...
                <div className="absolute bottom-0 w-full p-4 border-t border-[#e5e7eb] dark:border-[#2d3748]">
